...
>
> Falso. La descripción indicada corresponde a un intervalo de confianza en el mundo frecuentista.
>
> Verdadero.
...
grid_function <- function(mu, sigma){
  likelihood <- dnorm(1, mean = mu, sd = sigma^2)
  return(likelihood)
}
